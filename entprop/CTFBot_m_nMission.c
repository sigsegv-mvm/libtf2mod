...
uintptr_t entprop_extract_CTFBot_m_nMission(void)
{
	...
	uintptr_t off1 = 0;
	_entprop_extract_CTFBot_m_nMission_func1(&off1);
	EXTRACT_CHECK(off1);
	
	uintptr_t off2 = 0;
	_entprop_extract_CTFBot_m_nMission_func2(&off2);
	EXTRACT_CHECK(off2);
	
	uintptr_t off3 = 0;
	_entprop_extract_CTFBot_m_nMission_func3(&off3);
	EXTRACT_CHECK(off3);
	
	uintptr_t off4 = 0;
	_entprop_extract_CTFBot_m_nMission_func4(&off4);
	EXTRACT_CHECK(off4);
	
	uintptr_t off5 = 0;
	_entprop_extract_CTFBot_m_nMission_func5(&off5);
	EXTRACT_CHECK(off5);
	
	uintptr_t off6 = 0;
	_entprop_extract_CTFBot_m_nMission_func6(&off6);
	EXTRACT_CHECK(off6);
	
	uintptr_t off7 = 0;
	_entprop_extract_CTFBot_m_nMission_func7(&off7);
	EXTRACT_CHECK(off7);
