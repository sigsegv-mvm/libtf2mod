...
PATCH_CHECK
{
	uintptr_t off1 = vtable_find_offset("_ZTV16CTFWeaponBaseGun",
		CTFWeaponBaseGun_GetWeaponProjectileType);
	...
	uint8_t check1[] = {
		...
		0xff, 0x90, CONV_LE(off1)     // +0B35  call DWORD PTR [eax+GetWeaponProjectileType]
