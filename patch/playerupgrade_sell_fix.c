...
PATCH_CHECK
{
	size_t check1_base = 0x01ac;
	uint8_t check1[] = {
		0xc7, 0x85, 0x74, 0xfe, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, // +01AC  mov DWORD PTR [ebp-0x18c],0x0
		0x8b, 0xb5, 0x78, 0xfe, 0xff, 0xff,                         // +01B6  mov esi,DWORD PTR [ebp-0x188]
		0x85, 0xf6,                                                 // +01BC  test esi,esi
		0x74, 0x23,                                                 // +01BE  je +0x23
	};
...
PATCH_APPLY
{
	size_t data1_base = 0x01ac;
	uint8_t data1[] = {
		0xc7, 0x85, 0x74, 0xfe, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, // +01AC  mov DWORD PTR [ebp-0x18c],0xffff
	};
